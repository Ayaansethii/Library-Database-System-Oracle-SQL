...
CREATE TABLE Users (
    User_ID NUMBER GENERATED ALWAYS AS IDENTITY PRIMARY KEY,  -- Auto-incrementing primary key for users
...
CREATE TABLE Authors (
    Author_ID NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,  -- Auto-incrementing primary key for authors
...
CREATE TABLE Genres (
    Genre_ID NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,  -- Auto-incrementing primary key for genres
...
CREATE TABLE Loans (
    Loan_Number NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,  -- Auto-incrementing primary key for each loan
